...
namespace JKRPlatform.CommmGUI
{
    public partial class AreaForm : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            int number = this.radGridView1.ColumnCount - 10;
        ...
        {
            LookupData.SetPriceByLookUp(this.RepositoryItemLookUpEditPriceBy, base.m_uip, UIProxy.m_CurrentUserInformation.get_OfficeCode(), "");
